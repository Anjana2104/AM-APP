...
import { Upload, Table, Typography, Space, Button, message, Drawer, Tag, Segmented } from 'antd';
...
export default ResourceManagement;
            ...
            <div>
              ...
              <div style={{ fontSize: '16px', fontWeight: 600, marginTop: 4 }}>
                <Tag color="cyan">{selectedResource.role}</Tag>
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ fontSize: '14px', marginTop: 8, lineHeight: '1.8' }}>
                {selectedResource.skills.split(',').map((skill, idx) => (
            ...
            <div style={{ background: '#f5f5f5', padding: 16, borderRadius: 8 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '16px', fontWeight: 600 }}>
                    <Badge
                      count={(selectedResource.allocationPercentage || 0) + '%'}
                      color={selectedResource.allocationPercentage === 100 ? '#52C41A' : '#FFA940'}
            ...
            <div>
              ...
              <div style={{ fontSize: '14px', marginTop: 4, fontWeight: 600 }}>
                {selectedResource.currentProject || 'On Bench'}
              </div>
            </div>
